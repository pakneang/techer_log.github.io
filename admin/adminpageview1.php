  ...
  <div class="admin-page1">
    ...
    <div class="viewst">
      <div class="ro_st">
        ...
        <button class="bt-ro"><a href="../admin/admin_dashboard.php"> <i
              class="fas fa-house fa-btnr"></i>ទំព័រដើម</a></button>

      </div>
      <div class="st_text">
        <h4>បញ្ជីសិស្សចុះឈ្មោះសុំអាហារូបករណ៍ជំនាញ
        ...
        <div class="table-responsive-sm">
          <table class="view_tr">
            ...
            if (isset($_GET['major'])) {
              ...
              $sql = "SELECT * FROM student_register WHERE Skills = '" . $major . "'";
